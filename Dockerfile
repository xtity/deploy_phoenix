...
RUN echo "/usr/local/src/phoenix/app/${PHOENIX_APP_NAME}/rel/${PHOENIX_APP_NAME}/releases IN_CREATE /bin/bash /usr/local/src/phoenix/app/${PHOENIX_APP_NAME}/incron_release.sh" >> /var/spool/incron/root
